    ...
    public static class Program
    {
        ...
        public static void Main()
        {
            ...
            do
            {
                ...
                Console.WriteLine("     Samples will be readed asynchronously.");
                Console.WriteLine("     Samples will be handled by SamplesAvailable event.");
                Console.WriteLine(" [2] DEMO 2");
                Console.WriteLine("     Samples will be readed asynchronously.");
                Console.WriteLine("     Samples will be readed directly from the buffer.");
                Console.WriteLine(" [3] DEMO 3");
                Console.WriteLine("     Samples will be readed synchronously.");
